...
public class Carro {
  ...
  public static class CarroBuilder {
    ...
    private void validarRegrasCarro() {
      boolean validaPlaca = this.placa.isEmpty() || this.placa == null;
      boolean validaCor = this.cor == null;
      if (validaPlaca || validaCor) {
        throw new NullPointerException("Erro na regra carro");
      }
    }
  }
}
